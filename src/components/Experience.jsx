  ...
  const experiences = [
    {
      ...
      company: 'MindMed',
      period: '2022 - Present',
      description: 'Leading medical strategy and clinical development for breakthrough digital therapeutics in mental health and addiction. Overseeing clinical trials, regulatory strategy, and product development for innovative psychedelic-assisted therapies.',
